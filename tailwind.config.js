...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontFamily: {
        'new-spirit-medium': ['var(--font-new-spirit-medium)', 'Arial', 'Helvetica', 'sans-serif'],
        'new-spirit-medium-condensed': ['var(--font-new-spirit-medium-condensed)', 'Arial', 'Helvetica', 'sans-serif'],
